...
public class TestGUI {
	...
	static CenterMiddlePanel gameBacking = new CenterMiddlePanel();
	static CenterMiddlePanel yodaBacking = new CenterMiddlePanel();
	static CenterMiddlePanel darthBacking = new CenterMiddlePanel();
	...
	public static void main(String[] args) {
		...
		centerPlayBoard.centerMiddlePanel = gameBacking;
...
class CenterPlayBoard extends JPanel {
	...
	public CenterMiddlePanel centerMiddlePanel = new CenterMiddlePanel();
		...
		add(centerMiddlePanel, BorderLayout.CENTER);
	}
	...
	public void updateBackground(ImageIcon a) {
...
class CenterMiddlePanel extends JPanel {
	static ImageIcon bg = new ImageIcon("Assets/Floor/bg.jpg");
	static ImageIcon yodaend = new ImageIcon("Assets/Msg_new/yodaend.png");
	static ImageIcon darthend = new ImageIcon("Assets/Msg_new/darthend.png");
	static int CenterCounter = 0;

	static Image background = bg.getImage();
	...
	protected void paintComponent(Graphics g) {
		...
		if(CenterCounter <= 1){
			...
			background = yodaend.getImage();
			g.drawImage(background, 0, 0, getWidth(), getHeight(), Color.BLACK,
					this);
		}
		else{
			background = darthend.getImage();
			g.drawImage(background, 0, 0, getWidth(), getHeight(), Color.BLACK,
					this);
		}
		CenterCounter++;
